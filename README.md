...
Example output plots generated by MAGs-visualization are available in [`docs/images`](docs/images).
...
![dRep cluster plot](docs/images/drep_cluster_top30_phylum-genus.png)

### Completeness/contamination plot

![Completeness/contamination plot](docs/images/comp_conta_marginals_checkm2.png)